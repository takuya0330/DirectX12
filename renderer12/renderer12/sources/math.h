...
namespace math
{
	...
	inline constexpr float ToRadian(float degree)noexcept { return degree * (PI / 180.0f); }

	inline constexpr float ToDegree(float radian)noexcept { return radian * (180.0f / PI); }
